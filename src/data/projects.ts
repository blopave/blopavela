...
export const projects: Project[] = [
  ...
  { slug: 'lucid',        name: 'lucid',         category: 'Fintech',       role: 'Producto & Sistema',             shots: src('lucid'),        accent: '#efbf5c', ended: '2025-09',                                 blurb: 'Producto fintech: un dashboard de inversión y un sistema para explorar “mundos”.' },
  ...
  { slug: 'fini',         name: 'Fini',          category: 'Editorial',     role: 'Dirección de arte & Desarrollo', shots: src('fini'),         accent: '#e29a6b', ended: '',                                        blurb: 'Proyecto editorial: círculos y ciudades armando un manifiesto visual.' },
];
