...
export const projects: Project[] = [
  ...
  { slug: 'indoyoga',     name: 'IndoYoga',      category: 'Institucional', role: 'Diseño & Desarrollo',            shots: ord('indoyoga', [5,1,2,3,4]),     accent: '#e0a179', ended: '2024-06', url: 'https://indoyoga.org',    blurb: 'Sitio institucional de yoga: práctica viva, formaciones y comunidad.', stack: ['HTML', 'JavaScript', 'Vercel'], services: ['Diseño', 'Desarrollo'], approach: 'Llevar una escuela de Ashtanga de Gualeguaychú a una presencia digital seria. Sitio institucional con clases, formaciones, galería y scroll suave.' },
